...
import { ArrowRight, Book, Medal, Sparkles, Trophy, Star, BookOpen, GraduationCap, Languages, BrainCircuit } from "lucide-react";
...
// For this refactor I will keep it simple but improved visually.

const features = [
  {
    title: "965+ A1 Words",
    description: "Comprehensive vocabulary covering all essential German basics. From greetings to daily life.",
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-violet-600 via-indigo-600 to-blue-600 items-center justify-center p-4 relative overflow-hidden group">
  ...
  },
  {
    ...
    description: "Engagement focused exercises. Flashcards, writing, and speaking logic.",
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-blue-500 via-cyan-500 to-teal-400 items-center justify-center p-4 relative overflow-hidden group">
  ...
  {
    title: "Real Context",
    description: "Don't just memorize. Understand how words fit into authentic German sentences.",
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-pink-500 via-rose-500 to-orange-500 items-center justify-center p-4 relative overflow-hidden">
  ...
  },
  {
    ...
    description: "Our system tracks your memory decay and schedules reviews at the perfect moment.",
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-emerald-500 via-green-500 to-lime-500 items-center justify-center relative overflow-hidden p-6 group">
        <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(255,255,255,0.1)_50%,transparent_75%,transparent_100%)] bg-[length:250%_250%,100%_100%] bg-[position:-100%_0,0_0] bg-no-repeat transition-[background-position_0s] duration-0 hover:bg-[position:200%_0,0_0] hover:duration-[1500ms]"></div>
        <div className="grid grid-cols-5 gap-2 w-full h-full place-items-center opacity-60">
          {[...Array(10)].map((_, i) => (
            <div key={i} className={`w-full h-2 rounded-full ${i % 3 === 0 ? 'bg-white/80' : 'bg-white/20'}`}></div>
          ))}
        </div>
  ...
  },
  {
    ...
    description: "Aligned with European standards A1-B2. Track your progress professionally.",
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 items-center justify-center relative overflow-hidden">
        <div className="absolute bottom-0 left-0 w-full flex items-end justify-center px-8 gap-2 h-2/3">
          ...
          <div className="w-1/4 h-2/3 bg-white/50 rounded-t-lg relative">
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-white font-bold text-xs">B2</div>
          </div>
    ...
    <div className="flex flex-col min-h-[calc(100vh-4rem)] overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-32 overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full -z-10 opacity-40 blur-3xl saturate-150 pointer-events-none">
          ...
          <div className="absolute top-0 right-1/4 w-96 h-96 bg-blue-500/20 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-pulse delay-1000 lg:animate-aurora" style={{ animationDirection: 'reverse' }} />
        ...
        <div className="container px-6 mx-auto max-w-4xl relative z-10 flex flex-col items-center text-center">
          ...
          <motion.h1
            ...
            className="text-6xl sm:text-8xl font-black tracking-tight mb-8 text-foreground drop-shadow-sm leading-[1.05] max-w-3xl"
          >
            Master German <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-600 to-blue-600 animate-gradient bg-300%">
              With Confidence
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg sm:text-2xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed font-medium"
          >
            Learn faster with our scientifically proven spaced-repetition vocabulary cards.
            <span className="block mt-2 text-foreground font-bold">Free. Forever. Open Source.</span>
          </motion.p>
